...
export function getWeatherAdvice(temperature, isRaining) {
  // Let's the weather conditions and decide to go hiking or not
  
  if (temperature >= 35) return "Too hot for hiking - stay indoors and hydrate"
  else if (temperature >= 25 && isRaining == false) return "Great weather for hiking - don't forget sunscreen"
  else if (temperature >= 25 && isRaining == true) return "Warm but rainy - consider indoor activities"
  else if (temperature >= 15 && isRaining == false) return "Perfect hiking weather - enjoy the trails"
  else if (temperature >= 15 && isRaining == true) return "Cool and rainy - bring waterproof gear if hiking"
  else if (temperature >= 5 && isRaining == false) return "Chilly - wear layers to your hike"
  else if (temperature >= 5 && isRaining == true) return "Cold and wet - best to stay indoors" 
  else if (temperature < 5) return "Too cold - stay warm indoors"
  else return "Tell your temprature first then go to hiking"
}
